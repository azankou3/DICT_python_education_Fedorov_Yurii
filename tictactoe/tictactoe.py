...
def sym():
    symbol_1 = input("Player1 Enter what you want to be X or O?\n>")
    if symbol_1 == "X":
        symbol_2 = "O"
...
def startGamming(board, symbol_1, symbol_2, count):
    ...
    row = int(input("Pick a row:\n"
                    "top row: enter 0 is first,\n middle row: enter 1 is second,\n bottom row: enter 2 is third\n>"))
    column = int(input("Pick a column:"
                       "left column: enter 0,\nmiddle column: enter 1,\nright column enter 2\n>"))
    ...
    while (board[row][column] == symbol_1) or (board[row][column] == symbol_2):
        ...
        row = int(input("Pick a row top row:"
                        "enter 0 is first,\nmiddle row: enter 1 is second,\nbottom row: enter 2 is third\n>"))
        column = int(input("Pick a column:"
                           "left column: enter 0,\nmiddle column: enter 1,\nright column enter 2\n>"))
